package edu.qc.cs370.macrotracker.macrotracker.components;
...
public class CustomFoodItemAdapter extends BaseAdapter {
  ...
  private ArrayList<edu.qc.cs370.macrotracker.macrotracker.macro.Food> foodItems;

  public CustomFoodItemAdapter(Context context, ArrayList<edu.qc.cs370.macrotracker.macrotracker.macro.Food> foodItems) {
  ...
  @Override
  public edu.qc.cs370.macrotracker.macrotracker.macro.Food getItem(int position) {
