...
import edu.qc.cs370.macrotracker.BarcodeScannerActivity;
...
public class AddMealActivity extends AppCompatActivity {
  String scannedUPC;
  edu.qc.cs370.macrotracker.macrotracker.macro.Meal meal = new edu.qc.cs370.macrotracker.macrotracker.macro.Meal("Empty Meal");

  // Implementing a custom adapter to get the simple list item 2 layout functionality back. - DV
  edu.qc.cs370.macrotracker.macrotracker.components.CustomFoodItemAdapter adapter;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    // Implementing a custom adapter to get the simple list item 2 layout functionality back. - DV
    adapter = new edu.qc.cs370.macrotracker.macrotracker.components.CustomFoodItemAdapter(this, meal.getFoods());
  ...
  protected void onActivityResult(int requestCode, int resultCode, Intent data) {
    ...
    edu.qc.cs370.macrotracker.macrotracker.http.GetRequest.getViaUPC(this, foodInformationViews, scannedUPC);
  }

  public void scanBarcode(View view) {
    Intent intent = new Intent(this, edu.qc.cs370.macrotracker.macrotracker.BarcodeScannerActivity.class);
  ...
  public void addFoodToMeal(View view) {
    ...
    edu.qc.cs370.macrotracker.macrotracker.macro.Food food = new edu.qc.cs370.macrotracker.macrotracker.macro.Food(scannedUPC, fdName, fdCals, fdFat, fdCarbs, fdProtein, fdWeight);
